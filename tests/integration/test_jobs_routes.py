...
class TestJobsRoutes:
    ...
    def test_get_job_status(self, client, sample_user, sample_chat_type, sample_jwt_token, db_session):
    ...
    def test_delete_job(self, client, sample_user, sample_chat_type, sample_jwt_token, db_session):
