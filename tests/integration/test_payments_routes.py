...
class TestPaymentsRoutes:
    ...
    def test_subscribe_cannot_downgrade(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_subscribe_skip_payment_success(self, client, sample_user, sample_jwt_token):
    ...
    def test_subscribe_checkout_creation_success(self, client, sample_user, sample_jwt_token):
    ...
    def test_subscribe_cancel_existing_subscription(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_subscribe_customer_creation_failure(self, client, sample_user, sample_jwt_token):
    ...
    def test_subscribe_checkout_creation_failure(self, client, sample_user, sample_jwt_token):
    ...
    def test_refill_level_05_unlimited(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_refill_already_at_max(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_refill_skip_payment_success(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_refill_checkout_creation_success(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_refill_customer_id_already_exists(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_refill_generic_exception(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_cancel_pagarme_failure(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_cancel_generic_exception(self, client, sample_user, sample_jwt_token, db_session):
    ...
    def test_get_subscription_status_no_subscription(self, client, sample_user, sample_jwt_token):
    ...
    def test_webhook_subscription_created_no_target_level(self, client, sample_user, db_session):
