...
class SimpleRateLimiter:
    ...
    def is_blocked(self, key: str) -> tuple[bool, int | None]:
        """
    ...
    def check_attempt(self, key: str) -> tuple[bool, int | None]:
        """
        ...
        if len(self.attempts[key]) >= self.max_attempts:
            # Bloquear
            block_expiry = datetime.now(UTC) + timedelta(minutes=self.block_minutes)
    ...
    def record_attempt(self, key: str):
        ...
        self.attempts[key].append(datetime.now(UTC))
