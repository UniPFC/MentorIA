...
class TestSeederService:
    ...
    def test_seed_default_knowledge_creates_system_user(
        self, mock_auth, mock_listdir, mock_exists, mock_session_local
    ):
    ...
    @patch("src.services.seeder.os.listdir")
    @patch("src.services.seeder.auth_service")
    def test_seed_default_knowledge_updates_existing_user(
        self, mock_auth, mock_listdir, mock_exists, mock_session_local
    ):
        mock_exists.return_value = True
        mock_listdir.return_value = []
    ...
    @patch("src.services.seeder.os.listdir")
    @patch("src.services.seeder.auth_service")
    def test_seed_default_knowledge_skips_non_spreadsheet_files(
        self, mock_auth, mock_listdir, mock_exists, mock_session_local
    ):
        mock_exists.return_value = True
    ...
    @patch("src.services.seeder.auth_service")
    def test_seed_default_knowledge_creates_chat_type_with_separator(
        self, mock_auth, mock_join, mock_listdir, mock_exists, mock_session_local
    ):
        mock_exists.return_value = True
    ...
    @patch("src.services.seeder.os.path.join")
    @patch("src.services.seeder.auth_service")
    def test_seed_default_knowledge_creates_chat_type_without_separator(
        self, mock_auth, mock_join, mock_listdir, mock_exists, mock_session_local
    ):
        mock_exists.return_value = True
    ...
    def test_seed_default_knowledge_ingests_data(
        self,
        mock_file,
        mock_settings,
        mock_ingestion,
    ...
    @patch("src.services.seeder.os.path.join")
    @patch("src.services.seeder.auth_service")
    def test_seed_default_knowledge_skips_existing_data(
        self, mock_auth, mock_join, mock_listdir, mock_exists, mock_session_local
    ):
        mock_exists.return_value = True
        mock_listdir.return_value = ["data.xlsx"]
    ...
    @patch("src.services.seeder.os.path.exists")
    @patch("src.services.seeder.os.listdir")
    def test_seed_default_knowledge_handles_error(
        self, mock_listdir, mock_exists, mock_session_local
    ):
        mock_exists.return_value = True
